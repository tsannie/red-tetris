...
class Player {
  ...
  canMoveShadow(tetrimino) {
    ...
    const number_of_t_before_move = this.board.numberOfTOnGrid(this.board.gridWithCurrentTetrimino(tetrimino));
  ...
  canRotate() {
    ...
    const number_of_t_before_rotate = this.board.numberOfTOnGrid(this.board.gridWithCurrentTetrimino(this.tetrimino));
    const number_of_t_after_rotate = this.board.numberOfTOnGrid(this.board.gridWithCurrentTetrimino(tetrimino_to_test));
